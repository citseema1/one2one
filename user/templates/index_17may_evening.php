...
?> 
<div class="col-1-3 tc   "  style="position: relative;" >
<?php
$url = $fetch2['website'];

?>
<fieldset style="width: 100%; border: 1px solid #ccc; padding:5px;">
    <legend style="width: auto; padding:0 5px;  color:#fff; margin:0 5px; background-color: red;"><span ><?php echo ucfirst($get_member_type);?></span></legend>
