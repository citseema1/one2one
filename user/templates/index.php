...
<?php
// print_r($short_company_name);die;
?>
<!-- <title><?php //echo  "WFG One2One Meeting Scheduler"; ?></title> -->
<title><?php echo  ucfirst($short_company_name)." One2One Meeting Scheduler"; ?></title>
...
<!-- menu css js -->
<script src="user/templates/js/vendor/modernizr-2.6.2.min.js"></script>
<script>
...
<!-----------------------------old End---------------------------->
<script src="user/templates/js/organictabs.jquery.js"></script>
<script>
$(function() {
...
<!--<div class="dis_show"><img src="user/templates/images/logo_mobile.png"></div>-->
</div>
</div>
...
<img  src="<?php echo  $logo;?>" style="height:100px;" class="center-block">
</div>
</div>
</div>
...
<div class="bg">
    <div class="container">
        ...
        <div class="col-md-12">
            <div class="content dn1" align="center">
                <img src="https://develop.one2onescheduler.com/O2O/assets/event_logo/logo_220_140/faflogo_1526554924.jpg" style="height:100px;">
            </div>
        </div>
    </div>
...
<a  id="#core" href="?page=report_v1" style="cursor:pointer;"><i class="menu-icon fa  fa-bar-chart-o"></i><br />  Report</a> 
</li>
<?php if($close_ind!=1){?>
...
?>
 <?php if(isset($getLogo) && !empty($getLogo)){ ?>
...
<script src="user/templates/js/menu-new.js"></script>
<script type="text/javascript">
	$("#cssmenu").menumaker({
		title: "Menu",
		format: "multitoggle"
