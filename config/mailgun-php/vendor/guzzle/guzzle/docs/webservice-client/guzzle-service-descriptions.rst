...
heavily inspired by `Swagger <https://swagger.wordnik.com/>`_.
...
`JSON schema <https://tools.ietf.org/id/draft-zyp-json-schema-04.html>`_ syntax.
...
`URI-template expansion <https://tools.ietf.org/html/rfc6570>`_.
