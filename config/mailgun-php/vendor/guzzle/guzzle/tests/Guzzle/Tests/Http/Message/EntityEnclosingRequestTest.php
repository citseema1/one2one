...
class EntityEnclosingRequestTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $request = new EntityEnclosingRequest('PUT', 'https://test.com', array(
            'X-Test' => '123'
        ));
    ...
    {
        $request = new EntityEnclosingRequest('PUT', 'https://test.com', array('Content-Type' => 'foooooo'));
        $request->setBody('{"a":"b"}');
    ...
    public function testRequestIncludesBodyInMessage()
    {
        ...
        $request = RequestFactory::getInstance()->create('PUT', 'https://www.guzzle-project.com/', null, 'data');
    ...
    {
        $request = RequestFactory::getInstance()->create('POST', 'https://www.guzzle-project.com/', null, array(
            'foo' => 'bar'
        ));
    ...
    {
        $request = RequestFactory::getInstance()->create('POST', 'https://www.test.com/')
            ->addPostFiles(array(
                'file' => __FILE__
            ))->addPostFields(array(
                'a' => 'b'
    ...
    {
        $request = RequestFactory::getInstance()->create('PUT', 'https://www.test.com/');
    ...
    {
        $request = RequestFactory::getInstance()->create('PUT', 'https://www.test.com/', array(
    ...
    {
        $request = RequestFactory::getInstance()->create('POST', 'https://www.guzzle-project.com/');
    ...
    {
        $request = new EntityEnclosingRequest('POST', 'https://test.com');
    ...
    {
        $this->getServer()->enqueue("HTTP/1.1 200 OK\r\nContent-Length: 0\r\n\r\n");
        $request = new EntityEnclosingRequest('PUT', 'https://test.com/');
    ...
    {
        $request = new EntityEnclosingRequest('PUT', 'https://test.com/foo');
