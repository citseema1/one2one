...
class ClientTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testFactoryCreatesClient()
    {
        ...
        $this->assertEquals('https://www.test.com/', $client->getBaseUrl());
    ...
    {
        $client = new Mock\MockClient('https://www.foo.com', array(
    ...
    public function testSupportsServiceDescriptionBaseUrls()
    {
        ...
        $this->assertEquals('https://foo.com', $client->getBaseUrl());
    }
    ...
    {
        $client = new Mock\MockClient('https://foobaz.com');
