...
class OperationTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testOperationIsDataObject()
    {
        ...
        $this->assertEquals('https://www.example.com', $c->getDocumentationUrl());
    ...
    public function testCanBuildUpCommands()
    {
        ...
        $c->setName('foo')
            ...
            ->setDeprecated(false)
            ->setSummary('summary')
            ->setDocumentationUrl('https://www.foo.com')
            ->setHttpMethod('PUT')
            ->setResponseNotes('oh')
        ...
        $this->assertEquals('https://www.foo.com', $c->getDocumentationUrl());
