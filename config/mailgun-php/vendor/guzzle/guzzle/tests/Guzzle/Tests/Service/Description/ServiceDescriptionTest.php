...
class ServiceDescriptionTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $description = new ServiceDescription(array('baseUrl' => 'https://foo.com'));
        $this->assertEquals('https://foo.com', $description->getBaseUrl());
        $description->setBaseUrl('https://foobar.com');
        $this->assertEquals('https://foobar.com', $description->getBaseUrl());
    }

    public function testCanUseBasePath()
    {
        $description = new ServiceDescription(array('basePath' => 'https://foo.com'));
        $this->assertEquals('https://foo.com', $description->getBaseUrl());
    }
