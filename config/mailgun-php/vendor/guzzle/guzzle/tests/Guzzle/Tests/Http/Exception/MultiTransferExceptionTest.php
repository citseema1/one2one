...
class MultiTransferExceptionTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $r1 = new Request('GET', 'https://www.foo.com');
        $r2 = new Request('GET', 'https://www.foo.com');
    ...
    {
        $s = array($r1 = new Request('GET', 'https://www.foo.com'));
        $f = array($r2 = new Request('GET', 'https://www.foo.com'));
        $e = new MultiTransferException();
