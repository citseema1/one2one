...
class BackoffLoggerTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testLogsEvents()
    {
        ...
        $this->assertContains(
            '] PUT https://www.example.com - 503 Service Unavailable - Retries: 1, Delay: 3, Time: 2, 2, cURL: 30 Foo',
            $this->message
        );
    }
    ...
    protected function getMocks()
    {
        ...
        $request = RequestFactory::getInstance()->create('PUT', 'https://www.example.com', array(
            'Content-Length' => 3,
            'Foo'            => 'Bar'
        ));
