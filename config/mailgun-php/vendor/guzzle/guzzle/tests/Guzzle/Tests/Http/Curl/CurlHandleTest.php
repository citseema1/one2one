...
class CurlHandleTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        $request = RequestFactory::getInstance()->create('GET', 'https://test.com');
    ...
    {
        $h = new CurlHandle(curl_init('https://test.com'), array(CURLOPT_URL => 'https://test.com'));
    ...
    {
        $handle = curl_init('https://www.test.com/');
        $h = new CurlHandle($handle, array(
            CURLOPT_URL => 'https://www.test.com/'
        ));
    ...
    public function dataProvider()
    {
        ...
        $tests = array(
            // Send a regular GET
            array('GET', 'https://www.google.com/', null, null, array(
            ...
            array('TRACE', 'https://www.google.com/', null, null, array(
                CURLOPT_CUSTOMREQUEST => 'TRACE'
            )),
            // Send a GET using a port
            array('GET', 'https://127.0.0.1:8080', null, null, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION => 'callback',
            ...
            // Send a HEAD request
            array('HEAD', 'https://www.google.com/', null, null, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_HEADERFUNCTION => 'callback',
            ...
            array('GET', 'https://127.0.0.1:8124/', array(
                'x-test-data' => 'Guzzle'
            ), null, array(
                CURLOPT_PORT => 8124,
                CURLOPT_HTTPHEADER => array(
            ...
            array('POST', 'https://127.0.0.1:8124/post.php', null, $qs, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION => 'callback',
            ...
            array('PUT', 'https://127.0.0.1:8124/put.php', null, EntityBody::factory(fopen($testFile, 'r+')), array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION => 'callback',
            ...
            array('POST', 'https://127.0.0.1:8124/post.php', null, array(
                'x' => 'y',
                'a' => 'b'
            ), array(
                CURLOPT_RETURNTRANSFER => 0,
            ...
            array('POST', 'https://127.0.0.1:8124/post.php', array(
            ...
            array('POST', 'https://127.0.0.1:8124/post.php', null, array(), array(
                CURLOPT_CUSTOMREQUEST => 'POST',
                CURLOPT_HTTPHEADER => array (
                    'Expect:',
                    'Accept:',
            ...
            array('PATCH', 'https://127.0.0.1:8124/patch.php', null, 'body', array(
            ...
            array('DELETE', 'https://127.0.0.1:8124/delete.php', null, 'body', array(
             ...
             */
            array('GET', 'https://www.google.com#head', null, null, array(
                CURLOPT_RETURNTRANSFER => 0,
                CURLOPT_HEADER => 0,
                CURLOPT_CONNECTTIMEOUT => 150,
                CURLOPT_WRITEFUNCTION => 'callback',
        ...
        $postTest = array('POST', 'https://127.0.0.1:8124/post.php', null, $postBody, array(
            CURLOPT_RETURNTRANSFER => 0,
            CURLOPT_HEADER => 0,
            CURLOPT_CONNECTTIMEOUT => 150,
            CURLOPT_WRITEFUNCTION => 'callback',
    ...
    {
        $request = RequestFactory::getInstance()->create('GET', 'https://127.0.0.1:8124/');
    ...
    public function testCurlConfigurationOptionsAreSet()
    {
        ...
        $request->setClient(new Client('https://www.example.com'));
