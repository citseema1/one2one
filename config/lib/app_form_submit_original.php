...
function EmailMessageSent($ScheduledmeetingID,$purpose){
    ...
    if(($ScheduledmeetingID > 0)&&($purpose != '')){
        ...
        if(count($select_email) && !empty($select_email[0]['message']) && !empty($select_email[0]['subject'])){
            ...
            $message1=str_replace("{company logo}",$message_image, $message1);
            ...
            foreach($EachPEMAIL as $key_1=>$PEMAIL){
                if($PEMAIL!=""  ){
		            ...
		            $bcc = $cc = $reply = "";
		            mailgun_msg_send($PEMAIL,$message,$subject,$from_name,$bcc,$cc,$reply);
                }
            }
            ...
            foreach($EMWTPEMAIL as $PEACHMAIL){               
                if($PEACHMAIL!="" ){  
	                ...
	                $bcc = $cc = $reply = "";
	                mailgun_msg_send($PEACHMAIL,$message1,$subject,$from_name,$bcc,$cc,$reply);
                }
            }
        }
    }
